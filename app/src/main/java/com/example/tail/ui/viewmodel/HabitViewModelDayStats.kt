...
fun HabitViewModel.recalculateFitnessAgeDistance() {
    ...
    viewModelScope.launch {
        try {
            ...
            val fitnessAgeData = garminRepo.loadAllCachedData()[com.example.tail.data.health.GarminType.FITNESS_AGE]
            ...
            val allData = mapOf(
                com.example.tail.data.health.GarminType.FITNESS_AGE_DISTANCE to distanceData.toMap()
            )
