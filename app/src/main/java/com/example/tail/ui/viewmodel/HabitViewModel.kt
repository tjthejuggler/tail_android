...
import com.example.tail.ui.stats.GraphTimePeriod
...
class HabitViewModel(
    ...
    internal suspend fun syncChessComCurrentMonth() {
        ...
        try {
            ...
            val fetchedGames = mutableListOf<com.example.tail.data.chess.ChessComGame>()
    ...
    internal suspend fun applyChessComData(
        ...
        s: AppSettings,
        rawGames: List<com.example.tail.data.chess.ChessComGame> = emptyList(),
        ...
        for ((habitName, typeKey) in s.chessComHabitLinks) {
            ...
            if (todayDelta != null && todayDelta > 0) {
                ...
                val endTimes = if (newGames > 0) {
                    com.example.tail.data.chess.newGameEndTimes(
